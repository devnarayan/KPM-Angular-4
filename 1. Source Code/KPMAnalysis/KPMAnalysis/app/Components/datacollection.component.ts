...
import { IBranch } from '../Model/lookup';
...
export class DataCollectionComponent implements OnInit {
    ...
    LoadBranches(): void {
        this.indLoading = true;
        this._userService.getBranches(Global.BASE_Lookup_ENDPOINT+'branches')
            .subscribe(branches => { this.branches = branches; this.indLoading = false; },
            error => this.msg = <any>error);
    }
